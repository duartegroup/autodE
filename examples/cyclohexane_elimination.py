...
chlorocyclohexane = Reactant(
    name='chlorocyclohexane', smiles='ClC1CCCCC1', solvent='water')
chloride = Product(
...
reaction = Reaction(methoxide, chlorocyclohexane, chloride,
                    cyclohexene, methanol, name='cyclohexane_elimination')
