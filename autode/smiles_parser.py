...
class SmilesParser:
    ...
    def divide_smiles(self, string_to_divide):
        """Divides a SMILES string into its constituent parts.
           These are:
                     Atom (e.g 'Cl')
        ...
        while True:
            ...
            # get the whole contents of the bracket
    ...
    def analyse_bond_ring_string(self, bond_ring_string):
        ...
        while str_exists:
            ...
            # second time we encounter the ring number, form the bond
        ...
        for bond_no, bond_order in self.bond_order_dict.items():
            ...
            for i, atom in enumerate(bond):
                ...
                if atom in self.alkene_stereochem_dict.keys():
                    # as we assigned the stereochem to the next atom earlier, we now need to move it back to the right atoms
