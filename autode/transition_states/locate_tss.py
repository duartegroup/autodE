...
def get_bond_rearrangs(mol, product):
    ...
    for func in funcs:
        possible_bond_rearrangements = func(mol, product, possible_bond_rearrangements)
...
def get_fbonds_bbonds_1b(reactant, product, possible_bond_rearrangs):
...
def get_fbonds_bbonds_2b(reactant, product, possible_bond_rearrangs):
...
def get_fbonds_bbonds_1b1f(reactant, product, possible_bond_rearrangs):
...
def get_fbonds_bbonds_1b2f(reactant, product, possible_bond_rearrangs):
...
def get_fbonds_bbonds_2b1f(reactant, product, possible_bond_rearrangs):
...
def get_fbonds_bbonds_2b2f(reactant, product, possible_bond_rearrangs):
