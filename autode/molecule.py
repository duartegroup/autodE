...
class Molecule:
    ...
    def __init__(self, name='molecule', smiles=None, xyzs=None, solvent=None, charge=0, mult=1, is_fragment=False):
        ...
        Keyword Arguments:
            ...
            smiles {[type]} -- Standard SMILES string. e.g. generated by Chemdraw (default: {None})
            xyzs {[type]} -- e.g. [['C', 0.0, 0.0, 0.0], ...] (default: {None})
            solvent {[type]} -- Solvent that the molecule is immersed in. Will be used in optimise() and single_point() (default: {None})
